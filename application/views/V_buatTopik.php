...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
     <?php echo form_open('Controller/setTopik'); ?>
        <div class="section">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <form class="form-horizontal" role="form">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <?php echo form_input('judulTopik', '',['class' => 'form-control', 'placeholder'
                                        => 'Judul topik']);?>
                                </div>
                            </div>
                            <br>
                            <div class="form-group">
                                <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-10">
                                        <br>
                                        <?php echo form_textarea('isiTopik', '',['class' => 'form-control',
                                            'placeholder' => 'Tulis topik mu','required'] );?>
                                    </div>
                                </div>
                            <div class="form-group">
                                <div class="col-sm-2">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    ...
                                    ['class' => 'btn btn-default'],'required');?>
                                </div>
                            </div>
                        </form>
                    </div>
